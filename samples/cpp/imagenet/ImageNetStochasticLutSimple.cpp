...
#include "bb/Runner.h"
#include "bb/LoadImageNet.h"
#include "bb/ExportVeriImageNet


void ImageNetStochasticLutSimple(int epoch_size, int mini_batch_size, int test_modulation_size, bool binary_mode, bool file_read)
{
    std::string net_name       = "ImageNetStochasticLutSimple";
    std::string velilog_path   = "../../verilog/imagenet/";
    std::string velilog_module = "ImageNetLutSimple";
  ...
  // load imagenet data
...

    {
...

        {
            ...
            bb::WriteTestDataBinTextFile<float>(velilog_path + "imagenet_train.txt", velilog_path + "imagenet_test.txt", td);
        }
    }
}
