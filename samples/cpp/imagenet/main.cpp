...
int main(int argc, char *argv[])
{
    ...
    if ( netname == "All" || netname == "StochasticLutSimple" ) {
        ImageNetStochasticLutSimple(epoch_size, mini_batch_size, test_modulation_size, binary_mode, file_read);
    }

    if ( netname == "All" || netname == "StochasticLutCnn" ) {
        ImageNetStochasticLutCnn(epoch_size, mini_batch_size, test_modulation_size, binary_mode, file_read);
    }
